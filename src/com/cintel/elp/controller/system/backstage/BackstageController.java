package com.cintel.elp.controller.system.backstage;
...
import com.cintel.elp.common.utils.tree.MenuTreeUtil;
import com.cintel.elp.common.utils.webpage.PageData;
...
import com.cintel.elp.service.system.resources.ResourcesService;
...
public class BackstageController extends BaseController<Object>{
	...
	public AjaxRes getMenu(){	
		...
		try {
			...
			if(menus==null){
				//修改为默认显示系统功能
				if(StringUtils.isBlank(layer))layer="2";
