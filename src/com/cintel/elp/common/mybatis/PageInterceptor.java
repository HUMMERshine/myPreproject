package com.cintel.elp.common.mybatis;
...
import com.cintel.elp.common.utils.ReflectUtil;
...
public class PageInterceptor implements Interceptor {
	...
	private String getMysqlPageSql(Page<?> page, StringBuffer sqlBuffer) {
		...
		sqlBuffer.append(" limit ").append(page.getPageSize()).append(" offset ").append(offset);
		return sqlBuffer.toString();
	}
