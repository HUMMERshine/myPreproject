package com.cintel.elp.common.utils.email;
...
public class EmailHandle {
    ...
    public EmailHandle(String smtp,String port) {
        sendUserName = "";
        sendUserPass = "";
    ...
    private void setSmtpHost(String hostName,String port) {
        ...
        props.put("mail.smtp.port", ((StringUtils.isNotBlank(port))?port:"25"));
    }
    ...
    public boolean setFrom(String from,String fromName) {
        try {
            ...
            mimeMsg.setFrom(new InternetAddress(from,(StringUtils.isBlank(fromName)?from:fromName)));
            return true;
        } catch (Exception e) {
            return false;
        }
    ...
    public boolean setToList(String toList) {
        try {
            if (toList == null)
                return false;
            InternetAddress[] iaToList = InternetAddress.parse(toList.replace(";", ","));  
     ...
     * @return
     */
    public boolean setBlindCopyTo(String copyto) {
        try {
            if (copyto == null)
                return false;
            mimeMsg.setRecipients(Message.RecipientType.BCC,InternetAddress.parse(copyto));
            return true;
        } catch (Exception e) {
            return false;
        }
    ...
    public boolean setCopyToList(String copytoList) {
        try {
            if (copytoList == null)
                return false;
            InternetAddress[] iacopytoList = InternetAddress.parse(copytoList.replace(";", ","));  
            mimeMsg.setRecipients(Message.RecipientType.CC, iacopytoList);
            return true;
        } catch (Exception e) {
            return false;
        }
     ...
     * @return
     */
    public boolean setBlindCopyToList(String copytoList) {
        try {
            if (copytoList == null)
                return false;
            InternetAddress[] iacopytoList = InternetAddress.parse(copytoList.replace(";", ","));  
            mimeMsg.setRecipients(javax.mail.Message.RecipientType.BCC, iacopytoList);
            return true;
        } catch (Exception e) {
            return false;
        }
