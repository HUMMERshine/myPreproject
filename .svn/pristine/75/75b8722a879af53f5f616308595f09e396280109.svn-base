...
<body>
				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:23%" class="center">名称</th>
							<th style="width:30%" class="center">位置</th>
							<th style="width:10%" class="center">归属</th>
							<th style="width:5%"  class="center">联系人</th>
	...
	<script src="${jypath}/static/js/basicfun/warehouse/warehouse.js"></script>
</body>
</html>