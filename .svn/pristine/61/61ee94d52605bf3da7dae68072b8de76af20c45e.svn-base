		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand">
					<small>
						<i class="icon-leaf"></i>
						"五 跨" 应 急 物 流 综 合 指 挥 调 度 信 息 平 台
					</small>
				</a><!-- /.brand -->
			</div><!-- /.navbar-header -->
			<!-- 头部右边 -->
		...
		<div class="sidebar" id="sidebar">
			<div class="sidebar-shortcuts" id="sidebar-shortcuts">
				<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">	
					<button title="基础功能"  class="btn btn-primary" onclick="getMenu('2','y')"><i class="icon-th"></i></button>		
					<button title="应急处置"  class="btn btn-warning" onclick="getMenu('3','y')"><i class="icon-tasks"></i></button>					
					<button title="系统功能"  class="btn"             onclick="getMenu('1','y')"><i class="icon-desktop"></i></button>
					<button title="监控功能"  class="btn btn-success" onclick="getMenu('4','y')"><i class="icon-bitbucket"></i></button>
				</div>
				<!--左边 导航 小图标  -->
				<div class="sidebar-shortcuts-mini" id="sidebar-shortcuts-mini">
					<span title="基础功能" class="btn btn-primary"  onclick="getMenu('2','y')"></span>
					<span title="应急处置" class="btn btn-warning"  onclick="getMenu('3','y')"></span>
					<span title="系统功能" class="btn"              onclick="getMenu('1','y')"></span>
					<span title="监控功能" class="btn btn-success"  onclick="getMenu('4','y')" ></span>
				</div>
				<!--左边 导航 小图标  end-->
