				...
				<tbody>
					...
					<tr id="selectlayer" class="FormData" >
						...
						<td class="DataTD">&nbsp;
							...
							<button title="选择显示层级" value='3' class="btn btn-xs"><i class="icon-tasks"></i></button>	
					...
					<td class="CaptionTD"><font color="red">*</font>顺序：</td>
						<td class="DataTD">&nbsp;
						<input type="number" value="1" name="sort" min='1' max='99999' jyValidate="required,numrangeth" onkeyup='this.value=this.value.replace(/\D/g,&apos;&apos;)'  class="FormElement ui-widget-content ui-corner-all isSelect75"></td>
					</tr>		
					<tr class="FormData">
