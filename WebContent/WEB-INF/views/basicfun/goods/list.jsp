...
<body>
				...
				<table id="baseTable" class="table table-striped table-bordered table-hover" >
					<thead>
						<tr>
							...
							<th style="width:10%" class="center">类别</th>
							<th style="width:10%"  class="center">重量</th>
							<th style="width:10%" class="center">体积</th>
							<th style="width:10%" class="center">尺寸</th>
	...
	<script src="${jypath}/static/js/basicfun/goods/goods.js"></script>
</body>
</html>