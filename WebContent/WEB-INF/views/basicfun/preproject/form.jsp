			...
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text" maxlength="16" jyValidate="required" name="pre_name" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>灾害类型：</td>
						<td class="DataTD">&nbsp;
						<input type="text" maxlength="16" jyValidate="required" name="pre_kind" class="FormElement ui-widget-content ui-corner-all"></td>
						<td class="CaptionTD"><font color="red">*</font>灾害等级：</td>
						<td class="DataTD">&nbsp;
						<input type="text" maxlength="16" jyValidate="required" name="strength" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>受灾面积：</td>
						<td class="DataTD">&nbsp;
						<input type="text" maxlength="16" jyValidate="required" name="area" class="FormElement ui-widget-content ui-corner-all"></td>
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text" maxlength="16" jyValidate="required" name="climate" class="FormElement ui-widget-content ui-corner-all"></td>
