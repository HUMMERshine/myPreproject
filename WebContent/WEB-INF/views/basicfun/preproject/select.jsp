...
<div id="preoperateDiv" class="hide">
		<form id="preoperateForm" method="POST" onsubmit="return false;" >
			...
			<table id="preoperateTable" class="table table-striped table-bordered table-hover" style="word-break: break-all; word-wrap: break-all;">
					<thead>
						<tr>
							...
							<th style="width:30%" class="center hidden-480" >操作描述</th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
