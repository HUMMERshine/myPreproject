...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
    	$('#operateinfo').bootstrapTable({
			url : jypath+"/static/js/basicfun/preproject/operate_all.json",        //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
...
//    		var selects = $('#exampleTableToolbar').bootstrapTable('getSelections'); 
//    		if(selects.length != 1){
//    			swal("必须选择一个预案！")
//    		}else{
...
//    			url : "/elpdemo/static/basicfun/preproject/js/goods.json",        //请求后台的URL（*）
//    	        method: 'get',                      //请求方式（*）
