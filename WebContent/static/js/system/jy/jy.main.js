...
$(function() {
	...
	JY={Object:{notNull:function(obj) {//判断某对象不为空..返回true 否则 false
		...
		Model:{//loading框
			...
			check2:function(id,title,fn){
				$("#"+id).removeClass('hide').dialog({width:"80%",resizable:false,modal:true,title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"查看")+"</h4></div>",title_html:true,buttons:[{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(fn) == 'function'){fn.call(this);}}}]});
			},
			handle:function(id,title,button1,button2,fn1,fn2){
				$("#"+id).removeClass('hide').dialog({width:"80%",resizable:false,modal:true,title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"应急流程")+"</h4></div>",title_html:true,buttons:[{html: "<i class='icon-remove bigger-110'></i>&nbsp;"+button1,"class":"btn btn-xs",click:function(){if(typeof(fn1) == 'function'){fn1.call(this);}}},{html:"<i class='icon-ok bigger-110'></i>&nbsp;"+button2,"class":"btn btn-primary btn-xs",click:function(){if(typeof(fn2) == 'function'){fn2.call(this);}}}]});
			},
			...
			edit2:function(id,title,savefn,cancelfn){
				$("#"+id).removeClass('hide').dialog({width:"80%",resizable:false,modal:true,title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"修改")+"</h4></div>",title_html:true,buttons:[{html: "<i class='icon-ok bigger-110'></i>&nbsp;保存","class":"btn btn-primary btn-xs",click:function(){if(typeof(savefn) == 'function'){savefn.call(this);}}},{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}]});
			},
			//审核
